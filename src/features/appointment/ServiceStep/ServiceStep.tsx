    ...
    <div className="pt-10 pb-4">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          <ScissorsIcon size={14} className="text-brand-500" />
          <span className="text-brand-500 text-xs font-semibold uppercase tracking-[0.18em]">Berberi</span>
        </div>
        <h1 className="font-serif text-gray-900 text-4xl font-bold tracking-tight leading-tight">
          Mustafa Akkurt
        </h1>
      </div>
